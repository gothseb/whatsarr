...
FR19, FR20, UX-DR6, UX-DR7, NFR2, NFR3
...
- Logs UI must show sent, ignored, failed and deduplicated states clearly.
- Include `requestId` for API/log correlation where applicable.
...
- Before implementation, read previous story context if present: `N:\windsurf\whatsarr\_bmad-output\implementation-artifacts\4-9-detecter-et-notifier-les-nouveaux-episodes.md`.
