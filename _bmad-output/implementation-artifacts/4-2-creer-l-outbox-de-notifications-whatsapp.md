...
- This is the central anti-doublon foundation for all sends.
- Use deterministic `dedupe_key`; no direct WhatsApp send path is allowed.
...
- Before implementation, read previous story context if present: `N:\windsurf\whatsarr\_bmad-output\implementation-artifacts\4-1-creer-le-moteur-de-templates-de-messages.md`.
