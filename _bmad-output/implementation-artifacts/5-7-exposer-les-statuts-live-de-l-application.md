...
- SSE is preferred for live status; REST fallback should retrieve current status after reconnect.
- Avoid fast polling loops in the UI.
...
- Before implementation, read previous story context if present: `N:\windsurf\whatsarr\_bmad-output\implementation-artifacts\5-6-centraliser-les-logs-operationnels.md`.
