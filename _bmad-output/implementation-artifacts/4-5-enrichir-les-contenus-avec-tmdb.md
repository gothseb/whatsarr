...
- Degrade to Plex metadata when TMDB matching is uncertain.
- Include TMDB attribution in Settings/About surface when TMDB is used.
...
- Before implementation, read previous story context if present: `N:\windsurf\whatsarr\_bmad-output\implementation-artifacts\4-4-detecter-les-nouvelles-disponibilites-plex.md`.
