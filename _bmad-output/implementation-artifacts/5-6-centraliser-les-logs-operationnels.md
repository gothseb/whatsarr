...
- Logs must mask secrets and WhatsApp session data at persistence and display time.
- Use stable levels: debug, info, warn, error.
...
- Before implementation, read previous story context if present: `N:\windsurf\whatsarr\_bmad-output\implementation-artifacts\5-5-afficher-le-statut-du-recap-mensuel.md`.
