...
- Status must distinguish sent, failed and ignored reasons.
- Avoid exposing technical stack traces to the UI.
...
- Before implementation, read previous story context if present: `N:\windsurf\whatsarr\_bmad-output\implementation-artifacts\5-4-generer-et-envoyer-le-recap-mensuel.md`.
...
- Added dashboard controls to view and save the monthly recap day and time schedule.
